...
# test methods
	...
	test 'volunteer(s) present and returned method' do
		@extra_res = Reservation.new(start_date: Date.current, end_date: Date.tomorrow, pick_up_date: Date.current, return_date: Date.current, returned: true, picked_up: true, release_form_id: 1, kit_id: 3, teacher_id: 7, user_check_in: "John Smith", user_check_out: "Henry Ham" )
		assert @extra_res.valid?
		@extra_res.delete
